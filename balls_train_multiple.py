...
# construct dataset
dataset = nn_utils.TrainImagesDatasetMultiple(files_dir, width, height, num_classes=20, transforms=transform)
dataset_test = nn_utils.TrainImagesDatasetMultiple(test_dir, width, height, num_classes=20, transforms=transform)
